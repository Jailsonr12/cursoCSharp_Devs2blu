...
VALUES ('Ação'),('Drama'),('Fantasia'),('Ficção');
...
VALUES ('Livre',0,'exibição em qualquer horario'),
		('10 anos',10,'exibição em qualquer horario'),
        ('12 anos',10,'a partir das 20h'),
        ('14 anos',10,'a partir das 21h'),
        ('16 anos',10,'a partir das 22h'),
		('18 anos',10,'a partir das 23h');
